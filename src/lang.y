...
function_body:
       ...
       */
#line 10009 "prolang.y"
      {
#line 10011 "prolang.y"
          CURRENT_PROGRAM_SIZE = align(CURRENT_PROGRAM_SIZE);
          $<address>$ = CURRENT_PROGRAM_SIZE;
          if (realloc_a_program(FUNCTION_HDR_SIZE+1))
#line 10014 "prolang.y"
          {
              CURRENT_PROGRAM_SIZE += FUNCTION_HDR_SIZE;
          }
          else
#line 10018 "prolang.y"
          {
              yyerrorf("Out of memory: program size %"PRIuMPINT"\n"
                      , mem_block[A_PROGRAM].current_size + FUNCTION_HDR_SIZE);
              YYACCEPT;
...
#line 10181 "prolang.y"
          {
              if (current_inline->prev != -1)
#line 10183 "prolang.y"
              {
...
inline_opt_args:
      /* empty */
#line 10339 "prolang.y"
      {
          int i;

          /* Synthesize $1..$9 as arguments */
          for (i = 1; i < 10; i++)
#line 10344 "prolang.y"
          {
              char name[4];
              ident_t *ident;
...
#line 10738 "prolang.y"
              {
                  if (pragma_pedantic)
#line 10740 "prolang.y"
                  {
...
#line 11026 "prolang.y"
      {
          int num;

          num = find_struct($2.real, $2.override);
          if (num < 0)
#line 11031 "prolang.y"
          {
...
#line 11038 "prolang.y"
    ...
    | L_STRUCT L_MIXED
#line 11046 "prolang.y"
      {
        $$ = lpctype_any_struct;
      }
    | single_basic_non_void_type '*'
#line 11050 "prolang.y"
      {
          $$ = get_array_type($1);
          free_lpctype($1);
      }
    | '<' basic_non_void_type '>'
#line 11055 "prolang.y"
      {
          $$ = $2;
      }
...
#line 11147 "prolang.y"
      {
          $$ = $1;
          $$.num++;

          if ($3.name == NULL || $3.name->type != I_TYPE_LOCAL)
#line 11152 "prolang.y"
          {
              $$.num--;
...
#line 11158 "prolang.y"
          {
              /* We have a default value for the argument. */

              if ($$.num_opt == 0)
#line 11162 "prolang.y"
              {
...
#line 11201 "prolang.y"
          {
              /* A local name is redeclared. */
              if (current_inline == NULL)
#line 11204 "prolang.y"
              {
...
name_list:
      ...
      type L_IDENTIFIER
#line 11284 "prolang.y"
      {
#line 11286 "prolang.y"
          check_identifier($2);

          if ($1.t_type == NULL)
#line 11289 "prolang.y"
          {
    ...
    | type L_IDENTIFIER
#line 11301 "prolang.y"
      {
          check_identifier($2);

          if ($1.t_type == NULL)
#line 11305 "prolang.y"
          {
              yyerror("Missing type");
              $1.t_type = lpctype_mixed;
          }
...
#line 11383 "prolang.y"
      {
           ...
           * know it.
           */
#line 11390 "prolang.y"
          {
              block_scope_t *scope = block_scope + block_depth - 1;

              if (scope->num_locals > scope->num_cleared)
#line 11394 "prolang.y"
              {
                  mem_block[A_PROGRAM].block[scope->addr+2]
                    = (char)(scope->num_locals - scope->num_cleared);
              }
...
statements:
      /* empty */
#line 11409 "prolang.y"
      {
          $$ = (struct statement_s){ .may_return = false, .may_break = false, .may_continue = false, .may_finish = true, .is_empty = true, .warned_dead_code = false };
      }
    | statements local_name_list ';'
#line 11413 "prolang.y"
      {
          free_lpctype($2);
          $$ = $1;
          $$.is_empty = false;
...
#line 11525 "prolang.y"
      {
          $$ = (struct statement_s){ .may_return = true, .may_break = false, .may_continue = false, .may_finish = true, .is_empty = true, .warned_dead_code = true };
      }
    | cond | while | do | for | foreach | switch
    | return ';'
#line 11530 "prolang.y"
      {
          $$ = $1;
      }
    | block
    | /* empty */ ';'
#line 11535 "prolang.y"
      {
          $$ = (struct statement_s){ .may_return = false, .may_break = false, .may_continue = false, .may_finish = true, .is_empty = true, .warned_dead_code = false };
      }
    | L_BREAK ';'
...
#line 11595 "prolang.y"
              {
                  ins_f_code(F_BREAK_CONTINUE);
              }
          }
          else
#line 11600 "prolang.y"
          {
              /* Normal continue */
              ins_f_code(F_FBRANCH);
          }
...
#line 11618 "prolang.y"
    ...
    | L_RETURN comma_expr
#line 11628 "prolang.y"
      {
#line 11630 "prolang.y"
          fulltype_t type2 = $2.type;

          use_variable($2.name, VAR_USAGE_READ);

          if (exact_types)
#line 11635 "prolang.y"
          {
...
#line 11692 "prolang.y"
      {
#line 11694 "prolang.y"
...
#line 11746 "prolang.y"
      {
#line 11748 "prolang.y"
...
#line 11847 "prolang.y"
      {
          ...
          bc_offset_t next_addr;
          p_int current;
#line 11855 "prolang.y"
          current = CURRENT_PROGRAM_SIZE;
          for(; current_continue_address > 0
              ; current_continue_address = next_addr)
#line 11858 "prolang.y"
          {
              next_addr = read_jump_offset(current_continue_address);
              upd_jump_offset(current_continue_address,
...
#line 11867 "prolang.y"
      {
#line 11869 "prolang.y"
...
#line 11978 "prolang.y"
      {
#line 11980 "prolang.y"
          /* Save the previous environment */
          $<numbers>$[0] = current_continue_address;
          $<numbers>$[1] = current_break_address;
...
#line 11992 "prolang.y"
      {
#line 11994 "prolang.y"
...
#line 12005 "prolang.y"
      {
#line 12007 "prolang.y"
...
#line 12048 "prolang.y"
      {
#line 12050 "prolang.y"
           ...
           */
#line 12078 "prolang.y"
          {
              block_scope_t *scope = block_scope + block_depth - 1;

              if (scope->num_locals > scope->num_cleared)
#line 12082 "prolang.y"
              {
                  mem_block[A_PROGRAM].block[scope->addr+2]
                    = (char)(scope->num_locals - scope->num_cleared);
              }
...
#line 12091 "prolang.y"
      {
#line 12093 "prolang.y"
...
for_cond_expr:
      /* EMPTY */
#line 12279 "prolang.y"
      {
          last_expression = mem_block[A_PROGRAM].current_size;
          ins_number(1);
      }
    | comma_expr
#line 12284 "prolang.y"
      {
          use_variable($1.name, VAR_USAGE_READ);
          check_unknown_type($1.type.t_type);
...
for_iter_expr:
      /* EMPTY */
#line 12294 "prolang.y"
      {
          last_expression = mem_block[A_PROGRAM].current_size;
          ins_number(1);
      }
    | comma_expr
#line 12299 "prolang.y"
      {
          free_fulltype($1.type);
      }
; /* for_iter_expr */
...
#line 12350 "prolang.y"
      {
#line 12352 "prolang.y"
          /* Fix the number of locals to clear, now that we know it
           */
#line 12354 "prolang.y"
          {
              block_scope_t *scope = block_scope + block_depth - 1;

              if (scope->num_locals > scope->num_cleared)
#line 12358 "prolang.y"
              {
                  mem_block[A_PROGRAM].block[scope->addr+2]
                    = (char)(scope->num_locals - scope->num_cleared);
              }
...
foreach_expr:
      expr0
#line 12611 "prolang.y"
      {
          lpctype_t *dtype;
          Bool       gen_refs;

#line 12616 "prolang.y"
...
#line 12634 "prolang.y"
    ...
    | expr0 L_RANGE expr0
#line 12645 "prolang.y"
      {
          lpctype_t *dtype;

#line 12649 "prolang.y"
          if (($1.type.t_flags & TYPE_MOD_REFERENCE) != 0)
#line 12650 "prolang.y"
          {
              fulltype_error("Expression for foreach() of wrong type", $1.type);
          }
...
#line 12661 "prolang.y"
          {
              fulltype_error("Expression for foreach() of wrong type", $1.type);
          }

          if (($3.type.t_flags & TYPE_MOD_REFERENCE) != 0)
#line 12666 "prolang.y"
          {
...
#line 12779 "prolang.y"
      {
#line 12781 "prolang.y"
...
#line 12865 "prolang.y"
    {
#line 12867 "prolang.y"
...
#line 12891 "prolang.y"
    {
#line 12893 "prolang.y"
        /* Mark the current program address as another
         ...
         */
        if ($2.key >= $4.key)
#line 12909 "prolang.y"
        {
            if ($2.key > $4.key)
#line 12911 "prolang.y"
            {
...
#line 13046 "prolang.y"
          {
              current_code[-1] = F_BRANCH_WHEN_NON_ZERO;
          }
          else
#line 13050 "prolang.y"
          {
...
constant:
    ...
    | constant '*'   constant { $$ = $1 *  $3; }
    | constant '%'   constant
#line 13156 "prolang.y"
      {
          if ($3)
#line 13158 "prolang.y"
          {
              $$ = $1 % $3;
          }
          else
#line 13162 "prolang.y"
          {
...
bytes_constant:
      L_BYTES
#line 13227 "prolang.y"
      {
          last_string_constant = last_lex_string;
          last_lex_string = NULL;
      }
    | bytes_constant '+' L_BYTES
#line 13232 "prolang.y"
      {
          add_string_constant();
      }
    | L_BYTES L_BYTES
...
#line 13605 "prolang.y"
          {
              if (rttc2)
                 add_type_check(rttc2, TYPECHECK_ASSIGNMENT);

              if (!add_lvalue_code($1.lvalue, $2))
#line 13610 "prolang.y"
              {
                  free_lpctype($1.type);
                  free_fulltype($4.type);
                  free_fulltype(restype);
...
#line 14166 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | expr0 '+'
#line 14192 "prolang.y"
      {
#line 14194 "prolang.y"
          $<numbers>$[0] = last_expression;
          $<numbers>$[1] = last_string_is_new;
      }
      expr0
#line 14198 "prolang.y"
      {
          mp_uint current_size;
          bytecode_p p;
#line 14202 "prolang.y"
          $$ = $1;
...
#line 14278 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | expr0 '-' expr0
#line 14305 "prolang.y"
      {
#line 14307 "prolang.y"
          $$ = $1;
...
#line 14472 "prolang.y"
          {
              if(pragma_warn_empty_casts)
#line 14474 "prolang.y"
              {
                  if (pragma_pedantic)
...
#line 14483 "prolang.y"
          {
              if(pragma_warn_empty_casts)
#line 14485 "prolang.y"
              {
                  if (pragma_pedantic)
...
#line 14529 "prolang.y"
      {
          lpctype_t *result;
          $$.start = $1.start;

          if (!add_lvalue_code($2.lvalue, $1.code))
#line 14534 "prolang.y"
          {
              free_lpctype($2.type);
              YYACCEPT;
          }
...
#line 14555 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | '~' expr0
#line 14572 "prolang.y"
      {
#line 14574 "prolang.y"
          ins_f_code(F_COMPL);
...
#line 14688 "prolang.y"
      {
          uint32 current = CURRENT_PROGRAM_SIZE;

          if (!$1.lvalue.size)
#line 14692 "prolang.y"
          {
...
#line 14711 "prolang.y"
      {
          fulltype_t type1, type2, restype;
#line 14714 "prolang.y"
          $$ = $3;
...
#line 14755 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | expr4
#line 14778 "prolang.y"
      {
#line 14780 "prolang.y"
          $$ = $1;
      }
...
#line 14877 "prolang.y"
    ...
    | L_BYTES
#line 14892 "prolang.y"
      {
          /* Push a constant byte sequence */

          string_t *p;
#line 14897 "prolang.y"
          p = last_lex_string;
          last_lex_string = NULL;
          $$.start = last_expression = CURRENT_PROGRAM_SIZE;
          $$.type = get_fulltype_flags(lpctype_bytes, TYPE_MOD_LITERAL);
...
#line 14993 "prolang.y"
              {
                  // closure to global variable
                  variable_t *varp;

                  if (string_context)
#line 14998 "prolang.y"
                  {
...
#line 15126 "prolang.y"
      {
          ...
          if ($1 < 0x100)
#line 15135 "prolang.y"
          {
              ins_f_code(F_LAMBDA_CCONSTANT);
              ins_byte($1);
          }
          else
#line 15140 "prolang.y"
          {
...
#line 15273 "prolang.y"
    ...
    | '(' '<' struct_name '>'
#line 15281 "prolang.y"
      {
          int num;

          num = find_struct($3.real, $3.override);
          if (num < 0)
#line 15286 "prolang.y"
          {
...
#line 15293 "prolang.y"
          {
              ...
              if (idx < 0x100)
#line 15301 "prolang.y"
              {
                  ins_f_code(F_LAMBDA_CCONSTANT);
                  ins_byte(idx);
              }
              else
#line 15306 "prolang.y"
              {
                  ins_f_code(F_LAMBDA_CONSTANT);
                  ins_short(idx);
              }
...
#line 15370 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | L_DECLTYPE '('
#line 15383 "prolang.y"
      {
          $<address>$ = CURRENT_PROGRAM_SIZE;
          compiling_decltype++;
      }
      expr0 ')'
#line 15388 "prolang.y"
      {
          compiling_decltype--;
...
#line 15471 "prolang.y"
              ...
              if (i < 0)
#line 15490 "prolang.y"
              {
                  /* Already handled above. */
              }
              else if (i & VIRTUAL_VAR_TAG)
#line 15494 "prolang.y"
              {
...
#line 15513 "prolang.y"
              {
                  /* Access a non-virtual variable */

                  if (i & ~0xff)
#line 15517 "prolang.y"
                  {
                      bytecode_p q;
...
#line 15595 "prolang.y"
      {
          /* Lookup a struct member */
          int s_index = -1;
          int m_index = -1;

#line 15601 "prolang.y"
...
#line 15612 "prolang.y"
          {
              if (s_index == FSM_AMBIGUOUS) /* Not anymore. */
                  ins_prog_string($3);
              else
#line 15616 "prolang.y"
              {
                  ins_number(m_index);
                  free_mstring($3);
              }
...
#line 15637 "prolang.y"
      {
#line 15639 "prolang.y"
...
#line 15675 "prolang.y"
      {
#line 15677 "prolang.y"
          /* Generate a range expression */
          $$.start = $1.start;

          /* Is <expr4> already an lvalue? */
          if ($1.lvalue.size > 0)
#line 15682 "prolang.y"
          {
              /* Make <expr4> a protected lvalue, because we have to
               * evaluate the index expression first, before using it.
               */
...
#line 15721 "prolang.y"
      {
#line 15723 "prolang.y"
...
#line 15800 "prolang.y"
          {
              ...
              if (string_context)
#line 15806 "prolang.y"
              {
                  if (LAMBDA_VARIABLE(i).kind == LAMBDA_IDENT_OBJECT)
#line 15808 "prolang.y"
                  {
                      program_t *prog = get_current_object_program();
...
#line 15833 "prolang.y"
              ...
              if (i < 0)
#line 15849 "prolang.y"
              {
                  /* Already handled. */
              }
              else if (i & VIRTUAL_VAR_TAG)
#line 15853 "prolang.y"
              {
                  bytecode_p q;
...
#line 15869 "prolang.y"
              {
                  if (i & ~0xff)
#line 15871 "prolang.y"
                  {
                      bytecode_p q;
...
#line 15905 "prolang.y"
          {
              lpctype_t *type;
              bytecode_p q;
#line 15909 "prolang.y"
...
#line 15960 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | expr4 index_map_expr %prec '['
#line 15987 "prolang.y"
      {
          /* Generate/add an PUSH_INDEXED_MAP_LVALUE */

#line 15991 "prolang.y"
...
#line 16027 "prolang.y"
          /* Change the expr4 into an lvalue
           */
          if ($1.lvalue.size <= 0)
#line 16030 "prolang.y"
          {
...
#line 16040 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | expr4 index_map_range %prec '['
#line 16076 "prolang.y"
      {
#line 16078 "prolang.y"
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
    | expr4 member_operator struct_member_name %prec L_ARROW
#line 16110 "prolang.y"
      {
          /* Create a struct member lvalue */
          int s_index = -1;
          int m_index = -1;

#line 16116 "prolang.y"
          lpctype_t* result = get_struct_member_result_type($1.type.t_type, $3, $2.strict_member, &s_index, &m_index);
          if (!result)
              result = lpctype_mixed;
...
#line 16128 "prolang.y"
          {
              if ($3 != NULL) /* Compile time lookup. */
#line 16130 "prolang.y"
              {
                  if (s_index == FSM_AMBIGUOUS) /* Not anymore. */
                      ins_prog_string($3);
                  else
#line 16134 "prolang.y"
                  {
                      ins_number(m_index);
                      free_mstring($3);
                  }
...
#line 17137 "prolang.y"
          {
              /* We need an lvalue. */

              if ($1.lvalue.size <= 0)
#line 17141 "prolang.y"
              {
...
#line 17160 "prolang.y"
      {
          ...
          if (flags & TYPE_MOD_LVALUE)
#line 17168 "prolang.y"
          {
              /* We need an lvalue. */
              if ($1.lvalue.size <= 0)
#line 17171 "prolang.y"
              {
                  yyerrorf("Bad argument %d to %s: not a reference",
                        function_call_info[argument_level].arg_position,
                        get_txt(function_call_info[argument_level].fun_name));
...
#line 17192 "prolang.y"
              {
                  do
#line 17194 "prolang.y"
                  {
                      if (args->t_flags & TYPE_MOD_LVALUE)
#line 17196 "prolang.y"
                      {
...
function_call:
    ...
    /*- - - - - - - - - - - - - - - - - - - - - - - - - - - - -*/
      function_name
#line 17402 "prolang.y"
      {
#line 17404 "prolang.y"
...
#line 17613 "prolang.y"
                  {
                      /* Direct call */

                      if (ap_needed)
#line 17617 "prolang.y"
                      {
...
#line 17938 "prolang.y"
                          {
                              for (;;argp++)
#line 17940 "prolang.y"
                              {
                                  if ( argp->t_type == NULL )
#line 17942 "prolang.y"
                                  {
                   ...
                   */
                  if (max != min)
#line 17982 "prolang.y"
                  {
                      ap_needed = MY_TRUE;
                  }
                  else if (has_ellipsis)
#line 17986 "prolang.y"
                  {
                      ap_needed = MY_TRUE;
...
#line 18034 "prolang.y"
              {
                  ...
                  CURRENT_PROGRAM_SIZE += 3;
                  if (exact_types)
#line 18049 "prolang.y"
                  {
                      yyerrorf("Undefined function '%.50s'", get_txt($1.real->name));
                  }
                  else if (pragma_pedantic)
#line 18053 "prolang.y"
                  {
...
#line 18106 "prolang.y"
      {
#line 18108 "prolang.y"
          string_t *name;
          int sefun;
           ...
           */
#line 18122 "prolang.y"
          {
              bytecode_t *p, *q;
              p_int left;

              if (!realloc_a_program(1))
#line 18127 "prolang.y"
              {
                  yyerrorf("Out of memory: program size %"PRIuMPINT"\n"
...
#line 18297 "prolang.y"
                  {
                      ...
                      if (i > 4)
#line 18305 "prolang.y"
                      {
                          if (!realloc_a_program(i+2))
#line 18307 "prolang.y"
                          {
                              yyerrorf("Out of memory: program size %"PRIuMPINT"\n"
...
#line 18492 "prolang.y"
      {
#line 18494 "prolang.y"
          ident_t *fun = $3;
...
#line 18532 "prolang.y"
              {
                  yfree($1);
                  $$.super = NULL;
              }
              else
#line 18537 "prolang.y"
              {
                  $$.super = $1;
              }
          }
          else if (EVALUATION_TOO_LONG())
#line 18542 "prolang.y"
          {
              yyerrorf("Can't call master::%s for "
...
#line 18667 "prolang.y"
      {
#line 18669 "prolang.y"
...
#line 18772 "prolang.y"
      {
          if ($1 & $3 & CATCH_FLAG_RESERVE)
#line 18774 "prolang.y"
          {
...
#line 18978 "prolang.y"
        if (actual_type == lpctype_float)
#line 18979 "prolang.y"
        {
...
#line 19004 "prolang.y"
{
    /* We got a "<name> = <expr>" type declaration. */

#line 19008 "prolang.y"
...
#line 19043 "prolang.y"
{
    if (!name)
        return;

    if (name->type == I_TYPE_GLOBAL)
#line 19048 "prolang.y"
    {
...
#line 19080 "prolang.y"
{
    switch (usage)
#line 19082 "prolang.y"
    {
        case VAR_USAGE_NONE:
 ...
 * Returns the number of bytes written to the bytecode.
 */
#line 19264 "prolang.y"
{
    if (string_context)
#line 19266 "prolang.y"
    {
        svalue_t sv = svalue_lpctype(ref_lpctype(t));
        return ins_lambda_value(&sv);
    }
    else
#line 19271 "prolang.y"
    {
        PREPARE_INSERT(3);
...
#line 19355 "prolang.y"
{
    if (last_initializer_end < 0)
#line 19357 "prolang.y"
    {
...
#line 19475 "prolang.y"
            {
                unsigned short *update_index_map;
                inherit_t *inherits;

                if (string_context)
#line 19480 "prolang.y"
                {
                    program_t *prog = get_current_object_program();
...
#line 20143 "prolang.y"
            {
                if (STRUCT_DEF(id).inh >= 0)
#line 20145 "prolang.y"
                {
...
#line 20404 "prolang.y"
    {
        if (fun_map[oldix] == USHRT_MAX)
#line 20406 "prolang.y"
        {
...
#line 20533 "prolang.y"
        ...
        if (varfound)
#line 20544 "prolang.y"
        {
            *var_map = newvx - num_new_virtual_variables;

            if (update_existing)
#line 20548 "prolang.y"
            {
...
#line 20582 "prolang.y"
        {
            ...
            *var_map = num_new_variables + oldinheritp->num_additional_variables;
            ...
            if (update_existing)
#line 20590 "prolang.y"
            {
                int cur_oldindex = oldinheritp->variable_index_offset + oldvx - num_old_virtual_variables;
                variable_t *cur_oldvar = V_VARIABLE(cur_oldindex + VIRTUAL_VAR_TAG);
                if (last_additional_var != cur_oldvar)
#line 20594 "prolang.y"
                {
...
#line 20782 "prolang.y"
        {
            if (fun_map[*oldix] != USHRT_MAX)
                continue;

            if (is_old_inherited_function(from, first_function_index, oldinheritp, *oldix, update_existing))
#line 20787 "prolang.y"
            {
                oldfunp[*oldix].flags = NAME_UNDEFINED|NAME_HIDDEN|TYPE_MOD_PRIVATE;
...
#line 21901 "prolang.y"
{
    if (offset > 0)
#line 21903 "prolang.y"
    {
        store_line_number_info();
        stored_lines -= offset;
        while (offset > 256)
#line 21907 "prolang.y"
        {
            byte_to_mem_block(A_LINENUMBERS, LI_BACK);
...
#line 21962 "prolang.y"
        ...
        tmp = alloca(len+3);
        if (tmp == NULL)
#line 21973 "prolang.y"
        {
            yyerror("Out of stack memory: copy of name");
        }
        else
#line 21977 "prolang.y"
        {
            *tmp = delim == '"' ? delim
                                : (delim == '>' ? '<' : '(');
            strcpy(tmp+1, name);
...
#line 22000 "prolang.y"
    {
        if (last_include_start == mem_block[A_LINENUMBERS].current_size)
#line 22002 "prolang.y"
        {
            simple_includes++;
        }
        else
#line 22006 "prolang.y"
        {
            simple_includes = 0;
        }
...
#line 22043 "prolang.y"
{
    unsigned char c;

    stored_lines = include_line;
    if (last_include_start == mem_block[A_LINENUMBERS].current_size)
#line 22048 "prolang.y"
    {
...
#line 22133 "prolang.y"
{
    if (!pragma_no_simul_efuns)
#line 22135 "prolang.y"
    {
...
printf("DEBUG: prolog: type ptrs: %p, %p\n", local_variables, context_variables );
    ...
    if (isMasterObj)
#line 22259 "prolang.y"
    {
        for (applied_decl_t* decl = applied_decl_master; decl->returntype != NULL; decl++)
#line 22261 "prolang.y"
        {
...
#line 22268 "prolang.y"
    {
        for (applied_decl_t* decl = applied_decl_regular; decl->returntype != NULL; decl++)
#line 22270 "prolang.y"
        {
            int entry = mstring_get_hash(decl->name) & applied_decl_hash_table_mask;
            decl->next = applied_decl_hash_table[entry];
            applied_decl_hash_table[entry] = decl;
...
#line 22330 "prolang.y"
    ...
    if (all_efun_shadows)
#line 22336 "prolang.y"
    {
        efun_shadow_t *s, *t;

        for (t = all_efun_shadows; NULL != (s = t); )
#line 22340 "prolang.y"
        {
...
#line 22721 "prolang.y"
        {
            /* Nothing to sort */
            funname_start1 = funname_start2;
        }
        else
#line 22726 "prolang.y"
        {
            /* Mergesort again.
            ...
            do {
                ...
                if (!count1)
#line 22740 "prolang.y"
                {
                    out2 = &out_start1;
                    *out2 = funname_start2;
                    while (--count2 >= 0)
#line 22744 "prolang.y"
                    {
...
#line 22752 "prolang.y"
                {
                    out2 = &out_start1;
                    *out2 = funname_start1;
                    do
#line 22756 "prolang.y"
                    {
                        out2 = &(*out2)->offset.next;
                    } while (--count1);
                    funname_start1 = *out2;
...
#line 22781 "prolang.y"
                        {
                            *out1 = funname_start2;
                            out1 = &funname_start2->offset.next;
                            funname_start2 = *out1;
                            if (!--count2)
#line 22786 "prolang.y"
                            {
                                *out1 = funname_start1;
                                do {
...
#line 22796 "prolang.y"
                        {
                            *out1 = funname_start1;
                            out1 = &funname_start1->offset.next;
                            funname_start1 = *out1;
                            if (!--count1)
#line 22801 "prolang.y"
                            {
                                *out1 = funname_start2;
                                do {
                                    out1 = &(*out1)->offset.next;
...
#if 0
#line 22886 "prolang.y"
{
    int i, j;

    printf("DEBUG: --- structs in %s ---\n", current_loc.file->name);
    for (i = 0; i < STRUCT_COUNT; i++)
#line 22891 "prolang.y"
    {
        struct_type_t * ptype;
...
#line 23001 "prolang.y"
        {
            if ( !(f->flags & (NAME_INHERITED)))
#line 23003 "prolang.y"
            {
...
#line 23558 "prolang.y"
{
    if (type_of_arguments.block)
#line 23560 "prolang.y"
    {
